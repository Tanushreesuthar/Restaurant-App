...
public class Desert extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ListView Desertlist = findViewById(R.id.list_view_Desert);


        Dish[] dishes = {
                new Dish("Mushroom and tofu maki","tosted see wraped around sushi" , 999),
        ...
        Desertlist.setAdapter(dishesAdapter);
